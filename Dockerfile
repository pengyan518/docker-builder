...
RUN rclone copyto myR2:my-ai-models/models/lora_Flux_Dev_4-step.safetensors /comfyui/models/loras --config /root/.config/rclone/rclone.conf
RUN rclone copyto myR2:my-ai-models/models/shuimo_BRairt.F1_V1.safetensors /comfyui/models/loras --config /root/.config/rclone/rclone.conf
